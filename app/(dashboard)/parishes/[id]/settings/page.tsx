...
/**
 * Split out and keyed on the parish so the loaded settings seed `useState`
 * directly. Copying props into state from an effect would re-render twice and
 * fight anything the user had already typed.
 */
